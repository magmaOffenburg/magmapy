...
from magma.rcss.communication.rcss_action import BeamEffector, CreateEffector, InitEffector, PassModeEffector, SayEffector, SyncEffector


class SimSparkMessageEncoder:
    """Encoder for SimSpark action messages."""
