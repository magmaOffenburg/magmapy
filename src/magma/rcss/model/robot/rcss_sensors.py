...
from magma.agent.model.robot.sensors import Sensor, VisionSensor
from magma.common.math.geometry.vector import V3D_ZERO, Vector3D
from magma.rcss.communication.rcss_perception import ForceResistancePerceptor, RCSSLineDetection, RCSSPlayerDetection, RCSSVisionPerceptor
