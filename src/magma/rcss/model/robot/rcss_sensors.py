...
from magma.agent.model.robot.sensors import VisionSensor
from magma.rcss.communication.rcss_perception import RCSSLineDetection, RCSSPlayerDetection, RCSSVisionPerceptor
