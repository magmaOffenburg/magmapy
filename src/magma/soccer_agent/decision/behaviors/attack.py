...
from magma.agent.decision.behavior import ComplexBehavior, PBehavior
...
from magma.soccer_agent.decision.soccer_behaviors import PKickBehavior, PMoveToBehavior, SoccerBehaviorID
