...
from magma.common.math.geometry.angle import ANGLE_ZERO
from magma.soccer_agent.model.strategy.roles import DummyRole
from magma.soccer_agent.model.strategy.strategy import TeamStrategy
