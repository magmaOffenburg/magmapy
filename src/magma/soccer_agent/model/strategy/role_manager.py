...
from magma.soccer_agent.model.game_state import PlayModePhase, PSoccerGameState
from magma.soccer_agent.model.strategy.role import PMutableRole, PRole
from magma.soccer_agent.model.strategy.role_assignment import PRoleAssignmentStrategy
from magma.soccer_agent.model.strategy.strategy import PStrategyBook
