...
from magmapy.agent.decision.behaviors import NoneBehavior
...
from magmapy.agent.model.robot.robot_model import PMutableRobotModel, RobotModel
from magmapy.soccer_agent.decision.soccer_decision_maker import SoccerDecisionMaker
...
from magmapy.soccer_agent.model.strategy.role_assignment import PRoleAssignmentStrategy, RoleAssignmentStrategy
from magmapy.soccer_agent.model.strategy.role_manager import PMutableRoleManager, RoleManager
from magmapy.soccer_agent.model.strategy.strategies import DEFAULT_11_VS_11_STRATEGY
from magmapy.soccer_agent.model.strategy.strategy import PStrategyBook, SingletonStrategyBook
