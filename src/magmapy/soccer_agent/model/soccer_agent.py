...
from magmapy.agent.model.agent_model import AgentModel, PAgentModel, PMutableAgentModel
from magmapy.soccer_agent.model.game_state import SoccerGameState
...
if TYPE_CHECKING:
    ...
    from magmapy.soccer_agent.model.strategy.role_manager import PMutableRoleManager, PRoleManager
    from magmapy.soccer_agent.model.world.soccer_world import PMutableSoccerWorld, PSoccerWorld
