...
from magmapy.agent.model.robot.robot_model import PRobotModel
from magmapy.agent.model.robot.sensors import Loc3DSensor, VisionSensor
from magmapy.agent.model.world.objects import InformationSource, LineLandmark, PointLandmark
from magmapy.common.math.geometry.pose import P3D_ZERO
from magmapy.common.math.geometry.rotation import R3D_IDENTITY
from magmapy.common.math.geometry.vector import V3D_ZERO
from magmapy.soccer_agent.model.game_state import PSoccerGameState
from magmapy.soccer_agent.model.world.ifo import PSoccerIFO, SoccerIFO
from magmapy.soccer_agent.model.world.soccer_field_description import PSoccerFieldDescription
from magmapy.soccer_agent.model.world.soccer_map import PSoccerMap, SoccerMap
from magmapy.soccer_agent.model.world.soccer_objects import (
    PSoccerBall,
    PSoccerPlayer,
    PThisSoccerPlayer,
    SoccerBall,
