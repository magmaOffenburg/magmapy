...
from magmapy.agent.model.world.objects import InformationSource, MovableObject, PMovableObject

if TYPE_CHECKING:
    from magmapy.common.math.geometry.rotation import Rotation3D
