...
from magmapy.rchl.model.robot.rchl_actuators import RCHLTeamComActuator
from magmapy.rchl.model.robot.rchl_robot_description import RCHLActuatorType, RCHLSensorType
from magmapy.rchl.model.robot.rchl_sensors import RCHLTeamComSensor
