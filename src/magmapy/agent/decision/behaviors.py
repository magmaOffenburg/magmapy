...
from magmapy.agent.decision.behavior import Behavior, BehaviorID, PBehavior, PMoveBehavior, SingleComplexBehavior
from magmapy.agent.model.agent_model import PAgentModel
from magmapy.agent.model.robot.actuators import OmniSpeedActuator
